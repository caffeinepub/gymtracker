...
export class Backend implements backendInterface {
    ...
    async addProgressPhoto(arg0: ExternalBlob, arg1: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProgressPhoto(await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n9(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addSession(arg0: ExerciseSession): Promise<void> {
        if (this.processError) {
            try {
    ...
    async askAI(arg0: string): Promise<AIResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.askAI(arg0);
                return from_candid_AIResponse_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getRecommendedPlan(): Promise<WorkoutPlan | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecommendedPlan();
    ...
    async initializeWorkoutPlans(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeWorkoutPlans();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AIResponse_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AIResponse): AIResponse {
...
async function from_candid_ProgressPhoto_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProgressPhoto): Promise<ProgressPhoto> {
...
function from_candid_WorkoutPlan_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WorkoutPlan): WorkoutPlan {
    return from_candid_record_n14(_uploadFile, _downloadFile, value);
}
function from_candid__CaffeineStorageRefillResult_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: __CaffeineStorageRefillResult): _CaffeineStorageRefillResult {
    return from_candid_record_n5(_uploadFile, _downloadFile, value);
}
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WorkoutPlan]): WorkoutPlan | null {
    return value.length === 0 ? null : from_candid_WorkoutPlan_n13(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        recommendedPlan: record_opt_to_undefined(from_candid_opt_n12(_uploadFile, _downloadFile, value.recommendedPlan)),
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        fitnessLevel: from_candid_variant_n15(_uploadFile, _downloadFile, value.fitnessLevel),
        days: value.days,
        goal: from_candid_variant_n16(_uploadFile, _downloadFile, value.goal),
        name: value.name
    };
}
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "get_fit" in value ? Variant_get_fit_lose_weight_build_muscle.get_fit : "lose_weight" in value ? Variant_get_fit_lose_weight_build_muscle.lose_weight : "build_muscle" in value ? Variant_get_fit_lose_weight_build_muscle.build_muscle : value;
}
...
function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_WorkoutPlan>): Array<WorkoutPlan> {
    return value.map((x)=>from_candid_WorkoutPlan_n13(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProgressPhoto>): Promise<Array<ProgressPhoto>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ProgressPhoto_n26(_uploadFile, _downloadFile, x)));
}
...
function to_candid_record_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        age: value.age,
        fitnessLevel: to_candid_variant_n32(_uploadFile, _downloadFile, value.fitnessLevel),
        heightCm: value.heightCm,
        goal: to_candid_variant_n33(_uploadFile, _downloadFile, value.goal),
        weightKg: value.weightKg
    };
}
...
function to_candid_variant_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_intermediate_beginner_advanced): {
    intermediate: null;
} | {
    beginner: null;
} | {
...
function to_candid_variant_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_get_fit_lose_weight_build_muscle): {
    get_fit: null;
} | {
    lose_weight: null;
} | {
    ...
    return value == Variant_get_fit_lose_weight_build_muscle.get_fit ? {
        get_fit: null
